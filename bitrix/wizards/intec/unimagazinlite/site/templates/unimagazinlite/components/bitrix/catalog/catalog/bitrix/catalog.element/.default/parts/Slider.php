<?
	$this->addExternalJS(SITE_TEMPLATE_PATH."/js/jquery.elevatezoom.js");
?>
                    ...
                    <?if (!empty($arPictures)):?>
                        <?foreach ($arPictures as $sPicture):?>
                            <a rel="startshop-preview-images" href="<?=$sPicture?>" class="startshop-slider-preview-image startshop-image startshop-fancy">
                                ...
                                <img class="imgshow" data-zoom-image="<?=$sPicture?>" src="<?=$sPicture?>" alt="<?=htmlspecialcharsbx($arResult['NAME'])?>" title="<?=htmlspecialcharsbx($arResult['NAME'])?>" />
                            </a>
                        <?endforeach;?>
                    <?else:?>
            ...
            <div class="startshop-slider-slides">
                ...
                <script type="text/javascript">
                    $('document').ready(function () {
						...
						$(".imgshow").elevateZoom({zoomWindowHeight: 400, zoomWindowWidth:400,zoomWindowOffetx: 100,borderSize:1,cursor: "crosshair"});
                        $oSliderButtonRight.click(function () {
                            $oSlider.SlideNext();
                        });
							$(".startshop-slider-preview-images a").click(function(){return false;});
						<?elseif($options['CATALOG_PRODUCT_IMAGE_VIEW']['ACTIVE_VALUE']=='WITHOUT_EFFECTS'):?>
							$(".startshop-slider-preview-images a").click(function(){return false;});
						<?endif;?>
