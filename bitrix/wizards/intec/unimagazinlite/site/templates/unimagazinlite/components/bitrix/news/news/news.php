...
<div class="uni-panel-sort">
	<div class="sort">		
		...
		<div class="values">
			...
			<div class="value<?=($sort_p=='date'?' ui-state-active':'')?>">
				<a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam('sort=date&order='.$order_p,array('sort','order'),false);?>">
					<?=GetMessage("SECTION_SORT_DATE")?>					
					<div class="icon <?=$order?>"></div>
				</a>
			</div>
		</div>
