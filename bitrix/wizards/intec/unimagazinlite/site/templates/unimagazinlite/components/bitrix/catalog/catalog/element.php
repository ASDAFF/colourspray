<?
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"OCB_USE_ONECLICKBUY" => $arParams['OCB_USE_ONECLICKBUY'],
			"OCB_PROP_NAME" => $arParams['OCB_PROP_NAME'],
			"OCB_PROP_PHONE" => $arParams['OCB_PROP_PHONE'],
			"OCB_PROP_COMMENT" => $arParams['OCB_PROP_COMMENT']
		),
		$component
	);
