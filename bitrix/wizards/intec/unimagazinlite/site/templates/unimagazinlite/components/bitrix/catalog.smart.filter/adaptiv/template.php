						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "K"://RADIO_BUTTONS
									?>
									<div class="radio">
										<label class="bx-filter-param-label uni-button-radio" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
												<input
													type="radio"
													value=""
									...
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="radio">
											<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label uni-button-radio" for="<? echo $ar["CONTROL_ID"] ?>">
												<input
													type="radio"
													value="<? echo $ar["HTML_VALUE_ALT"] ?>"
								...
								default: //CHECKBOXES
									...
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="checkbox">
											<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label uni-button-checkbox <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
												<input
													type="checkbox"
