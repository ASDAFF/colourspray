...
<?if (($arResult['ERROR']['CODE'] == 0 || $arResult['ERROR']['CODE'] >= 4) && !$arResult['SENT']):?>
    <form action="<?=$APPLICATION->GetCurPage()?>" id="<?=$sUniqueID?>" class="startshop-forms-result-new default">
            ...
            <?foreach ($arResult['PROPERTIES'] as $iPropertyID => $arProperty):?>
                <?if ($arProperty['TYPE'] == STARTSHOP_FORM_PROPERTY_TYPE_TEXT):?>
                    <div class="controls">
                        ...
                        <div class="input">
                            <input type="text" name="<?=htmlspecialcharsbx($arProperty['CODE'])?>" class="inputtext startshop-input-text startshop-input-text-standart" value="<?=htmlspecialcharsbx($_REQUEST[$arProperty['CODE']])?>"<?=$arProperty['READONLY'] == 'Y' ? ' readonly="readonly"' : ''?> />
                ...
                <?elseif ($arProperty['TYPE'] == STARTSHOP_FORM_PROPERTY_TYPE_TEXTAREA):?>
                    <div class="startshop-forms-result-new-row">
                        ...
                        <div class="startshop-forms-result-new-row-control">
                            <textarea name="<?=htmlspecialcharsbx($arProperty['CODE'])?>" class="startshop-input-textarea startshop-input-textarea-standart"<?=$arProperty['READONLY'] == 'Y' ? ' readonly="readonly"' : ''?>><?=htmlspecialcharsbx($_REQUEST[$arProperty['CODE']])?></textarea>
                        </div>
                        <?if ($arResult['ERROR']['CODE'] == 5):?>
                            <?if (array_key_exists($arProperty['CODE'], $arResult['ERROR']['FIELDS']['EMPTY'])):?>
                                <div class="startshop-forms-result-new-message-error">
		...
		<a href="/consent" target="_blank">
            ...
            <input type="submit" class="solid_button startshop-forms-result-new-button startshop-button startshop-button-standart" value="<?=$arResult['LANG'][LANGUAGE_ID]['BUTTON']?>" />
			</div>
