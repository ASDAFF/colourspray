...
$MESS["MAIN_ELEMENT_ID"] = "Главный контакт";
$MESS["MAIN_ELEMENT_CODE"] = "Главный контакт (код)";
$MESS["SECTION_ALL_ENABLED"] = "Включить раздел \"Все\"";
$MESS["CONTACT_FORM_ID"] = "ID формы обратной связи";
?>