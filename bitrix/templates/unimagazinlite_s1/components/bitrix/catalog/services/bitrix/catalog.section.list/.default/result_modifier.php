...
$arViewModeList = array('LIST', 'TEXT', 'TILE', 'MENU');

$rsSections = CIBlockSection::GetList(
	array('name' => 'asc'),
	array('IBLOCK_ID' => $arParams['IBLOCK_ID'], 'SECTION_ID' => false, 'ACTIVE' => 'Y', 'GLOBAL_ACTIVE' => 'Y'),
	false
);
...
{
	$mxPicture = false;
	$section["PICTURE"] = intval($section["PICTURE"]);
	if (0 < $section["PICTURE"])
		$mxPicture = CFile::GetFileArray($section["PICTURE"]);
	$section["PICTURE"] = $mxPicture;
