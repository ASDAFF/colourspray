							...
							<?if ($arItem['STARTSHOP']['AVAILABLE']) {?>
                                <div class="startshop-buy">
									<?//if (!$arItem['STARTSHOP']['BASKET']['INSIDE']):?>
										...
										<a rel="nofollow" href="<?=$arParams["BASKET_URL"];?>" id="in_cart_<?=$arElement['ID']?>" class="startshop-button startshop-button-standart startshop-status-focus to-cart-added addedToBasket addedToBasket<?=$arItem["ID"]?>" style="display:none;">
