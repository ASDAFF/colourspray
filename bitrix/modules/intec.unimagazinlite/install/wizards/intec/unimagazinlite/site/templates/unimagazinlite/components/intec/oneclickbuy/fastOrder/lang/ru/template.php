...
$MESS['CAPTION_USER_NAME'] = 'Ваше имя';
$MESS['CAPTION_USER_PHONE'] = 'Контактный телефон';
$MESS['CAPTION_COMMENT'] = 'Комментарий к заказу';
$MESS['CAPTION_EMAIL'] = 'E-mail';
$MESS['CAPTION_SKU_SELECT'] = 'Свойства товара';
$MESS['ORDER_LINK'] = 'Быстрый заказ';
$MESS['FORM_HEADER_CAPTION'] = 'Быстрый заказ';
$MESS['ORDER_BUTTON_CAPTION'] = 'Отправить заказ';
...
$MESS['IBLOCK_FORM_IMPORTANT'] = 'Это поле необходимо заполнить';
$MESS['IBLOCK_FORM_PROMPT'] = 'Обязательно для заполнения';
$MESS['CONSENT'] = 'согласен на обработку персональных данных';
