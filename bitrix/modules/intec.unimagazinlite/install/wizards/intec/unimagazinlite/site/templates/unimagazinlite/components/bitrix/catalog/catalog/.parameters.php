...
<?
	...
	$arTemplateParameters['SHOW_MAX_QUANTITY'] = array(
		'PARENT' => 'VISUAL',
		'NAME' => GetMessage('SH_C_SHOW_MAX_QUANTITY'),
		'TYPE' => 'CHECKBOX',
		'DEFAULT' => 'N',
	);
    ...
    if ($arCurrentValues['USE_REVIEW']=='Y') {
        ...
        $arTemplateParameters["MESSAGES_PER_PAGE"] = array(
            "PARENT" => "REVIEW_SETTINGS",
            "NAME" => GetMessage("MESSAGES_PER_PAGE"),
            "TYPE" => "STRING",
            "DEFAULT" => 10
        );
    }
	...
	/* Купить в один клик */
		...
		$arTemplateParameters['OCB_USE_ONECLICKBUY'] = array(
			'NAME' => GetMessage('OCB_USE_ONECLICKBUY'),
			'PARENT' => 'VISUAL',
			'TYPE' => 'CHECKBOX',
			'DEFAULT' => 'Y',
			'REFRESH' => 'Y'
		...
		if ($arCurrentValues['OCB_USE_ONECLICKBUY'] == 'Y') {
			
			$arTemplateParameters['OCB_PROP_NAME'] = array(
				"NAME" => GetMessage('OCB_PROP_NAME'),
				'PARENT' => 'VISUAL',
				"TYPE" => "LIST",
				"VALUES" => $arOrderProps,
				'DEFAULT' => 'NAME',
			...
			$arTemplateParameters['OCB_PROP_PHONE'] = array(
				"NAME" => GetMessage('OCB_PROP_PHONE'),
				'PARENT' => 'VISUAL',
				"TYPE" => "LIST",
				"VALUES" => $arOrderProps,
				'DEFAULT' => 'PHONE',
			...
			$arTemplateParameters['OCB_PROP_COMMENT'] = array(
				"NAME" => GetMessage('OCB_PROP_COMMENT'),
				'PARENT' => 'VISUAL',
				"TYPE" => "LIST",
				"VALUES" => $arOrderProps,
				'DEFAULT' => 'COMMENT',
