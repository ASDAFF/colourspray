...
<a class="startshop-basket-small mobile-header startshop-link startshop-link-hover-dark<?=$arParams['DISPLAY_COUNT'] == "Y" ? ' startshop-with-count' : ''?>" href="<?=$arParams['URL_BASKET']?>">
